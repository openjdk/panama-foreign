...
final class Byte256Vector extends ByteVector {
    ...
    Byte256Shuffle iotaShuffle(int start) { 
        return (Byte256Shuffle)VectorIntrinsics.shuffleIota(ETYPE, Byte256Shuffle.class, VSPECIES, VLENGTH, start, (val, l) -> new Byte256Shuffle(i -> (Byte256Shuffle.partiallyWrapIndex(i + val, l))));
    }
    ...
    Byte256Vector uOp(FUnOp f) {
        return (Byte256Vector) super.uOp(f);  // specialize
    }

    @ForceInline
    final @Override
    Byte256Vector uOp(VectorMask<Byte> m, FUnOp f) {
        return (Byte256Vector) super.uOp((Byte256Mask)m, f);  // specialize
    }
    ...
    Byte256Vector bOp(Vector<Byte> v, FBinOp f) {
        return (Byte256Vector) super.bOp((Byte256Vector)v, f);  // specialize
    }
    ...
    Byte256Vector bOp(Vector<Byte> v,
        ...
        return (Byte256Vector) super.bOp((Byte256Vector)v, (Byte256Mask)m,
                                        f);  // specialize
    }
    ...
    Byte256Vector tOp(Vector<Byte> v1, Vector<Byte> v2, FTriOp f) {
        return (Byte256Vector) super.tOp((Byte256Vector)v1, (Byte256Vector)v2,
                                        f);  // specialize
    }
    ...
    public Byte256Vector slice(int origin) {
       if ((origin < 0) || (origin >= VLENGTH)) {
         ...
         Byte256Shuffle Iota = iotaShuffle(origin);
