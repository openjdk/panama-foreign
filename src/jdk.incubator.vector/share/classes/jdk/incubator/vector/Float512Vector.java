...
final class Float512Vector extends FloatVector {
    ...
    @ForceInline
    Float512Shuffle iotaShuffle(int start) { 
        return (Float512Shuffle)VectorIntrinsics.shuffleIota(ETYPE, Float512Shuffle.class, VSPECIES, VLENGTH, start, (val, l) -> new Float512Shuffle(i -> (Float512Shuffle.partiallyWrapIndex(i + val, l))));
    }
    ...
    Float512Vector bOp(Vector<Float> v, FBinOp f) {
        return (Float512Vector) super.bOp((Float512Vector)v, f);  // specialize
    }
    ...
    Float512Vector bOp(Vector<Float> v,
        ...
        return (Float512Vector) super.bOp((Float512Vector)v, (Float512Mask)m,
                                        f);  // specialize
    }
    ...
    Float512Vector tOp(Vector<Float> v1, Vector<Float> v2, FTriOp f) {
        return (Float512Vector) super.tOp((Float512Vector)v1, (Float512Vector)v2,
                                        f);  // specialize
    }
    ...
    public Float512Vector slice(int origin) {
       if ((origin < 0) || (origin >= VLENGTH)) {
         ...
         Float512Shuffle Iota = iotaShuffle(origin);
