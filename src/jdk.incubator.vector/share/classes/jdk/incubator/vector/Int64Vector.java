...
final class Int64Vector extends IntVector {
    ...
    Int64Vector bOp(Vector<Integer> o, FBinOp f) {
        return (Int64Vector) super.bOp((Int64Vector)o, f);  // specialize
    }

    @ForceInline
    final @Override
    Int64Vector bOp(Vector<Integer> o,
                     VectorMask<Integer> m, FBinOp f) {
        return (Int64Vector) super.bOp((Int64Vector)o, (Int64Mask)m,
                                        f);  // specialize
    }
    ...
    Int64Vector tOp(Vector<Integer> o1, Vector<Integer> o2, FTriOp f) {
        return (Int64Vector) super.tOp((Int64Vector)o1, (Int64Vector)o2,
                                        f);  // specialize
    }

    @ForceInline
    final @Override
    Int64Vector tOp(Vector<Integer> o1, Vector<Integer> o2,
