...
final class Int512Vector extends IntVector {
    ...
    @ForceInline
    Int512Shuffle iotaShuffle(int start) { 
        return (Int512Shuffle)VectorIntrinsics.shuffleIota(ETYPE, Int512Shuffle.class, VSPECIES, VLENGTH, start, (val, l) -> new Int512Shuffle(i -> ((i + val) & (l-1))));
    }
    ...
    Int512Vector bOp(Vector<Integer> v, FBinOp f) {
        return (Int512Vector) super.bOp((Int512Vector)v, f);  // specialize
    }
    ...
    Int512Vector bOp(Vector<Integer> v,
        ...
        return (Int512Vector) super.bOp((Int512Vector)v, (Int512Mask)m,
                                        f);  // specialize
    }
    ...
    Int512Vector tOp(Vector<Integer> v1, Vector<Integer> v2, FTriOp f) {
        return (Int512Vector) super.tOp((Int512Vector)v1, (Int512Vector)v2,
                                        f);  // specialize
    }
    ...
    static final class Int512Shuffle extends AbstractShuffle<Integer> {
        ...
        private Int512Vector toVector_helper() {
            return (Int512Vector) super.toVectorTemplate();  // specialize
        }
