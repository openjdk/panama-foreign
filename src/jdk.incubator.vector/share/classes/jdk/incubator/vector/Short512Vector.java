...
final class Short512Vector extends ShortVector {
    ...
    Short512Shuffle iotaShuffle(int start) { 
        return (Short512Shuffle)VectorIntrinsics.shuffleIota(ETYPE, Short512Shuffle.class, VSPECIES, VLENGTH, start, (val, l) -> new Short512Shuffle(i -> ((i + val) & (l-1))));
    }
    ...
    Short512Vector uOp(FUnOp f) {
        return (Short512Vector) super.uOp(f);  // specialize
    }

    @ForceInline
    final @Override
    Short512Vector uOp(VectorMask<Short> m, FUnOp f) {
        return (Short512Vector) super.uOp((Short512Mask)m, f);  // specialize
    }
    ...
    Short512Vector bOp(Vector<Short> v, FBinOp f) {
        return (Short512Vector) super.bOp((Short512Vector)v, f);  // specialize
    }
    ...
    Short512Vector bOp(Vector<Short> v,
        ...
        return (Short512Vector) super.bOp((Short512Vector)v, (Short512Mask)m,
                                        f);  // specialize
    }
    ...
    Short512Vector tOp(Vector<Short> v1, Vector<Short> v2, FTriOp f) {
        return (Short512Vector) super.tOp((Short512Vector)v1, (Short512Vector)v2,
                                        f);  // specialize
    }
    ...
    static final class Short512Shuffle extends AbstractShuffle<Short> {
        ...
        private Short512Vector toVector_helper() {
            return (Short512Vector) super.toVectorTemplate();  // specialize
        }
