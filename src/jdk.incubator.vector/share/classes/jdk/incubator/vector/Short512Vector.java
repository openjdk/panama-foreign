...
final class Short512Vector extends ShortVector {
    ...
    public Short512Vector shiftLanesLeft(int j) {
       ...
       if (j < 0) {
         ...
         Short512Shuffle     Iota    = (Short512Shuffle)(VectorShuffle.shuffleIota(SPECIES, L-j));
         VectorMask<Short> BlendMask = Iota.toVector().lessThan(Short512Vector.broadcast(SPECIES, (short)(L-j)));
         Iota    = (Short512Shuffle)(VectorShuffle.shuffleIota(SPECIES, L -j));
    ...
    public Short512Vector shiftLanesRight(int j) {
       ...
       if (j < 0) {
         ...
         Short512Shuffle     Iota    = (Short512Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         VectorMask<Short> BlendMask = Iota.toVector().greaterThanEq(Short512Vector.broadcast(SPECIES, (short)(j)));
         Iota    = (Short512Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         return ZERO.blend(this.rearrange(Iota),BlendMask);
       }
    }
    ...
    static final class Short512Shuffle extends AbstractShuffle<Short> {
        ...
        public ShortVector toVector() {
            return VectorIntrinsics.shuffleToVector(Short512Vector.class, short.class, Short512Shuffle.class, this,
                                                    SPECIES.length(), 
                                                    (s) -> (((Short512Shuffle)(s)).toVector_helper()));
        }
