...
final class Double512Vector extends DoubleVector {
    ...
    Double512Shuffle iotaShuffle(int start) { 
        return (Double512Shuffle)VectorIntrinsics.shuffleIota(ETYPE, Double512Shuffle.class, VSPECIES, VLENGTH, start, (val, l) -> new Double512Shuffle(i -> ((i + val) & (l-1))));
    }
    ...
    Double512Vector uOp(FUnOp f) {
        return (Double512Vector) super.uOp(f);  // specialize
    }

    @ForceInline
    final @Override
    Double512Vector uOp(VectorMask<Double> m, FUnOp f) {
        return (Double512Vector) super.uOp((Double512Mask)m, f);  // specialize
    }
    ...
    static final class Double512Shuffle extends AbstractShuffle<Double> {
        ...
        private Double512Vector toVector_helper() {
            return (Double512Vector) super.toVectorTemplate();  // specialize
        }
