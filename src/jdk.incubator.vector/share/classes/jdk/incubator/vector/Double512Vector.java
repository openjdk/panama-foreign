...
final class Double512Vector extends DoubleVector {
    ...
    public Double512Vector shiftLanesLeft(int j) {
       ...
       if (j < 0) {
         ...
         Double512Shuffle     Iota    = (Double512Shuffle)(VectorShuffle.shuffleIota(SPECIES, L-j));
         VectorMask<Double> BlendMask = Iota.toVector().lessThan(Double512Vector.broadcast(SPECIES, (double)(L-j)));
         Iota    = (Double512Shuffle)(VectorShuffle.shuffleIota(SPECIES, L -j));
    ...
    public Double512Vector shiftLanesRight(int j) {
       ...
       if (j < 0) {
         ...
         Double512Shuffle     Iota    = (Double512Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         VectorMask<Double> BlendMask = Iota.toVector().greaterThanEq(Double512Vector.broadcast(SPECIES, (double)(j)));
         Iota    = (Double512Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         return ZERO.blend(this.rearrange(Iota),BlendMask);
       }
    }
    ...
    static final class Double512Shuffle extends AbstractShuffle<Double> {
        ...
        public DoubleVector toVector() {
            return VectorIntrinsics.shuffleToVector(Double512Vector.class, double.class, Double512Shuffle.class, this,
                                                    SPECIES.length(), 
                                                    (s) -> (((Double512Shuffle)(s)).toVector_helper()));
        }
