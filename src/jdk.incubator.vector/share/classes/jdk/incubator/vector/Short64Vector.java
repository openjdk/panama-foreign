...
final class Short64Vector extends ShortVector {
    ...
    public Short64Vector shiftLanesLeft(int j) {
       ...
       if (j < 0) {
         ...
         Short64Shuffle     Iota    = (Short64Shuffle)(VectorShuffle.shuffleIota(SPECIES, L-j));
         VectorMask<Short> BlendMask = Iota.toVector().lessThan(Short64Vector.broadcast(SPECIES, (short)(L-j)));
         Iota    = (Short64Shuffle)(VectorShuffle.shuffleIota(SPECIES, L -j));
    ...
    public Short64Vector shiftLanesRight(int j) {
       ...
       if (j < 0) {
         ...
         Short64Shuffle     Iota    = (Short64Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         VectorMask<Short> BlendMask = Iota.toVector().greaterThanEq(Short64Vector.broadcast(SPECIES, (short)(j)));
         Iota    = (Short64Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         return ZERO.blend(this.rearrange(Iota),BlendMask);
       }
    }
    ...
    static final class Short64Shuffle extends AbstractShuffle<Short> {
        ...
        public ShortVector toVector() {
            return VectorIntrinsics.shuffleToVector(Short64Vector.class, short.class, Short64Shuffle.class, this,
                                                    SPECIES.length(), 
                                                    (s) -> (((Short64Shuffle)(s)).toVector_helper()));
        }
