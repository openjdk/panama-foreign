...
final class Int256Vector extends IntVector {
    ...
    public Int256Vector shiftLanesLeft(int j) {
       ...
       if (j < 0) {
         ...
         Int256Shuffle     Iota    = (Int256Shuffle)(VectorShuffle.shuffleIota(SPECIES, L-j));
         VectorMask<Integer> BlendMask = Iota.toVector().lessThan(Int256Vector.broadcast(SPECIES, (int)(L-j)));
         Iota    = (Int256Shuffle)(VectorShuffle.shuffleIota(SPECIES, L -j));
    ...
    public Int256Vector shiftLanesRight(int j) {
       ...
       if (j < 0) {
         ...
         Int256Shuffle     Iota    = (Int256Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         VectorMask<Integer> BlendMask = Iota.toVector().greaterThanEq(Int256Vector.broadcast(SPECIES, (int)(j)));
         Iota    = (Int256Shuffle)(VectorShuffle.shuffleIota(SPECIES, j));
         return ZERO.blend(this.rearrange(Iota),BlendMask);
       }
    }
    ...
    static final class Int256Shuffle extends AbstractShuffle<Integer> {
        ...
        public IntVector toVector() {
            return VectorIntrinsics.shuffleToVector(Int256Vector.class, int.class, Int256Shuffle.class, this,
                                                    SPECIES.length(), 
                                                    (s) -> (((Int256Shuffle)(s)).toVector_helper()));
        }
