...
void DowncallStubGenerator::generate() {
  ...
  if (_save_thread_local_mask != 0) {
    ...
    __ ldr(c_rarg0, Address(sp, locs.data_offset(StubLocations::SAVE_THREAD_LOCAL)));
    __ movw(c_rarg1, _save_thread_local_mask);
    __ rt_call(CAST_FROM_FN_PTR(address, DowncallLinker::save_thread_local), tmp1);
