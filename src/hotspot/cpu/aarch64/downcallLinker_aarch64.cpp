...
void DowncallStubGenerator::generate() {
  ...
  if (_preserve_value_mask != 0) {
    ...
    __ ldr(c_rarg0, Address(sp, locs.data_offset(StubLocations::PRESERVE_VALUE)));
    __ movw(c_rarg1, _preserve_value_mask);
    __ rt_call(CAST_FROM_FN_PTR(address, DowncallLinker::preserve_value), tmp1);
