...
ciObject* ciObjectFactory::create_new_object(oop o) {
  ...
  if (o->is_instance()) {
    ...
    else if (java_lang_invoke_NativeEntryPoint::is_instance(o))
      return new (arena()) ciNativeEntryPoint(h_i);
    else if (jdk_internal_invoke_ABIDescriptor::is_instance(o))
      return new (arena()) ciABIDescriptor(h_i);
    else if (jdk_internal_invoke_VMStorage::is_instance(o))
