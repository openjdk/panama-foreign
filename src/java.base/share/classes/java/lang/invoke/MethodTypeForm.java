...
final class MethodTypeForm {
    ...
    static final int
            ...
            LF_INVNATIVE               =  6,  // NMH invokeNative
            LF_INTERPRET               =  7,  // LF interpreter
            LF_REBIND                  =  8,  // BoundMethodHandle
            LF_DELEGATE                =  9,  // DelegatingMethodHandle
            LF_DELEGATE_BLOCK_INLINING = 10,  // Counting DelegatingMethodHandle w/ @DontInline
            LF_EX_LINKER               = 11,  // invokeExact_MT (for invokehandle)
            LF_EX_INVOKER              = 12,  // MHs.invokeExact
            LF_GEN_LINKER              = 13,  // generic invoke_MT (for invokehandle)
            LF_GEN_INVOKER             = 14,  // generic MHs.invoke
            LF_CS_LINKER               = 15,  // linkToCallSite_CS
            LF_MH_LINKER               = 16,  // linkToCallSite_MH
            LF_GWC                     = 17,  // guardWithCatch (catchException)
            LF_GWT                     = 18,  // guardWithTest
            LF_TF                      = 19,  // tryFinally
            LF_LOOP                    = 20,  // loop
            LF_INVSPECIAL_IFC          = 21,  // DMH invokeSpecial of (private) interface method
            LF_LIMIT                   = 22;
