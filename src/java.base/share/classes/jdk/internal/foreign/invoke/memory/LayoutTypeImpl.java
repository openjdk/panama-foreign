...
public class LayoutTypeImpl<X> implements LayoutType<X> {
    ...
    LayoutTypeImpl(Class<?> carrier, Layout layout, References.Reference reference) {
    ...
    public static <X> LayoutType<X> of(Class<X> carrier, Layout layout, References.Reference reference) {
        return new LayoutTypeImpl<>(carrier, layout, reference);
    }

    @SuppressWarnings("unchecked")
    public static <X> LayoutType<Callback<X>> ofCallback(Address layout, References.Reference reference, Class<X> funcIntf) {
