...
public class Util {
    ...
    private static jdk.internal.nicl.types.Type typeof2(java.lang.reflect.Type t) {
        if (t instanceof Class) {
            ...
            } else if (isVectorType(c)) {
                switch (getVectorSize(c)) {
                    case 16:
                        return Types.M128;
                    case 32:
                        return Types.M256;
    ...
    public static int getVectorSize(Class<?> c) {
        if (c == Long2.class) {
            return (int) Types.M128.getSize();
        } else if (c == Long4.class) {
            return (int) Types.M256.getSize();
        } else if (c == Long8.class) {
            return (int) Types.M512.getSize();
        }
