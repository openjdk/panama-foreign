...
public class Errno {
    ...
    public Errno() {
        try {
            errnoMH = MethodHandles.publicLookup().findNative(getErrnoLocationFunctionName(), MethodType.methodType(long.class));
            strerrorMH = MethodHandles.publicLookup().findNative("strerror", MethodType.methodType(long.class, int.class));
