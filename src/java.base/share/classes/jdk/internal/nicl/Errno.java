...
public class Errno {
    ...
    public int errno() {
        try {
            Pointer<Integer> p = Util.createPtr((long)errnoMH.invoke(), LayoutType.create(int.class));
            return p.lvalue().get();
        } catch (Throwable t) {
    ...
    public String strerror(int errno) {
        try {
            Pointer<Byte> p = Util.createPtr((long)strerrorMH.invoke(errno), LayoutType.create(byte.class));
