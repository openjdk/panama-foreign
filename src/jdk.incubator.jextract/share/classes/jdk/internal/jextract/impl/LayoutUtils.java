...
public final class LayoutUtils {
    ...
    static {
        if (abi instanceof SysVx64ABI) {
            ...
            C_UCHAR = SystemABI.SysV.C_UCHAR;
            C_SCHAR = SystemABI.SysV.C_SCHAR;
            C_SHORT = SystemABI.SysV.C_SHORT;
            C_USHORT = SystemABI.SysV.C_USHORT;
            C_INT = SystemABI.SysV.C_INT;
            C_UINT = SystemABI.SysV.C_UINT;
            C_LONG = SystemABI.SysV.C_LONG;
            C_ULONG = SystemABI.SysV.C_ULONG;
            C_LONGLONG = SystemABI.SysV.C_LONGLONG;
            C_ULONGLONG = SystemABI.SysV.C_ULONGLONG;
            ...
            C_UCHAR = SystemABI.Win64.C_UCHAR;
            C_SCHAR = SystemABI.Win64.C_SCHAR;
            C_SHORT = SystemABI.Win64.C_SHORT;
            C_USHORT = SystemABI.Win64.C_USHORT;
            C_INT = SystemABI.Win64.C_INT;
            C_UINT = SystemABI.Win64.C_UINT;
            C_LONG = SystemABI.Win64.C_LONG;
            C_ULONG = SystemABI.Win64.C_ULONG;
            C_LONGLONG = SystemABI.Win64.C_LONGLONG;
            C_ULONGLONG = SystemABI.Win64.C_ULONGLONG;
            ...
            C_UCHAR = SystemABI.AArch64.C_UCHAR;
            C_SCHAR = SystemABI.AArch64.C_SCHAR;
            C_SHORT = SystemABI.AArch64.C_SHORT;
            C_USHORT = SystemABI.AArch64.C_USHORT;
            C_INT = SystemABI.AArch64.C_INT;
            C_UINT = SystemABI.AArch64.C_UINT;
            C_LONG = SystemABI.AArch64.C_LONG;
            C_ULONG = SystemABI.AArch64.C_ULONG;
            C_LONGLONG = SystemABI.AArch64.C_LONGLONG;
            C_ULONGLONG = SystemABI.AArch64.C_ULONGLONG;
