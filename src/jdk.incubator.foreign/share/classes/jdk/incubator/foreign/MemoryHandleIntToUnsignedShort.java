...
final class MemoryHandleIntToUnsignedShort {
    private static final MethodHandle TO_TARGET;
    private static final MethodHandle FROM_TARGET;

    static {
        try {
            TO_TARGET = MethodHandles.lookup().findStatic(MemoryHandleIntToUnsignedShort.class, "shortValue",
    ...
    private MemoryHandleIntToUnsignedShort() { } // no instances
