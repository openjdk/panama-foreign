...
final class MemoryHandleUnsignedByteFromInt {
    private static final MethodHandle TO_TARGET;
    private static final MethodHandle FROM_TARGET;

    static {
        try {
            TO_TARGET = MethodHandles.lookup().findStatic(MemoryHandleUnsignedByteFromInt.class, "toTarget",
                    MethodType.methodType(byte.class, int.class));
            FROM_TARGET = MethodHandles.lookup().findStatic(MemoryHandleUnsignedByteFromInt.class, "fromTarget",
    ...
    private MemoryHandleUnsignedByteFromInt() { } // no instances
