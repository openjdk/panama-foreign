 ...
 * crucial that the resources associated with a memory segment are released when the segments are no longer in use, by calling the {@link jdk.incubator.foreign.MemorySegment#close()}
