 ...
 */
public class DirectUpcallHandler implements UpcallHandler {

    @Stable
    private final MethodHandle mh;
    private final long entryPoint;

    public DirectUpcallHandler(MethodHandle target, CallingSequence callingSequence, MethodType type) {
        DirectSignatureShuffler shuffler =
                DirectSignatureShuffler.nativeToJavaShuffler(callingSequence, type);
