...
public final class Shapes {
    ...
    public static final class S32Bit implements Vector.Shape<Vector<?, S32Bit>> {
        private S32Bit() {}

        @Override
        public int bitSize() { return 32; }

        @Override
        public int length(Vector.Species<?,?> s) { return bitSize() / s.elementSize(); }
    }
