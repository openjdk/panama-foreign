...
public class AddArraysLong4PS {
    ...
    private static void addArrays(float[] left, float[] right, float[] res, int i){
        Long4 l = PatchableVecUtils.long4FromFloatArray(left,i);
        Long4 rr = PatchableVecUtils.vaddps(l,right,i);
        PatchableVecUtils.long4ToFloatArray(res,i,rr);
    }
