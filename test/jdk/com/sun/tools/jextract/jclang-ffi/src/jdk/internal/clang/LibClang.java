...
public class LibClang {
    ...
    static final Index_h lib;
    private static final CXString_h lcxstr;
    ...
    static {
        ...
        lib = Libraries.bind(Index_h.class, libclang);
        lcxstr = Libraries.bind(CXString_h.class, libclang);
    }
