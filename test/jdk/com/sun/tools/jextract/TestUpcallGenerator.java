...
/**
 * This class is used to generate the files "libTestUpcall.c" and corresponding header "libTestUpcall.h".
 * To generate the .c file, run w/o arguments; to generate .h file, use the 'header' argument.
 */
public class TestUpcallGenerator {
    ...
    static void generateFunction(Ret ret, List<ParamType> params, List<StructFieldType> fields, boolean declOnly) {
        ...
        String res = String.format("EXPORT %s f%d_%s_%s_%s(%s %s) %s", retType, fCode, retCode, sigCode, structCode,
