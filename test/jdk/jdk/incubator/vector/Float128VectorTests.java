...
public class Float128VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void lanewise_FIRST_NONZEROFloat128VectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Float128VectorTests::lanewise_FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void lanewise_FIRST_NONZEROFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float128VectorTests::lanewise_FIRST_NONZERO);
    }
    ...
    static void lanewise_FMAFloat128VectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb, IntFunction<float[]> fc) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, c, r, Float128VectorTests::lanewise_FMA);
    }


    @Test(dataProvider = "floatTernaryOpMaskProvider")
    static void lanewise_FMAFloat128VectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb,
        ...
        assertArraysEquals(a, b, c, r, mask, Float128VectorTests::lanewise_FMA);
    }
