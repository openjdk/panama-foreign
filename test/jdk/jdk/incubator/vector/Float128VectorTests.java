...
public class Float128VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    static void ADDFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 0;
        ...
        assertReductionArraysEquals(a, r, ra, Float128VectorTests::ADD, Float128VectorTests::ADD);
    }
    ...
    static void ADDFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float128VectorTests::ADDMasked, Float128VectorTests::ADDMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MULFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        float ra = 1;
        ...
        assertReductionArraysEquals(a, r, ra, Float128VectorTests::MUL, Float128VectorTests::MUL);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MULFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float128VectorTests::MULMasked, Float128VectorTests::MULMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MINFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Float128VectorTests::MIN, Float128VectorTests::MIN);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MINFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float128VectorTests::MINMasked, Float128VectorTests::MINMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void MAXFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Float128VectorTests::MAX, Float128VectorTests::MAX);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void MAXFloat128VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float128VectorTests::MAXMasked, Float128VectorTests::MAXMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void sliceFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        ...
        assertArraysEquals(a, r, origin, Float128VectorTests::slice);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void sliceFloat128VectorTestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, Float128VectorTests::slice);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void unsliceFloat128VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(a, r, origin, Float128VectorTests::unslice);
    }
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void unsliceFloat128VectorTestsBinary(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = new float[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, part, Float128VectorTests::unslice);
    }
