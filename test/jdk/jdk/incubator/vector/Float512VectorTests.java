...
public class Float512VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void maxFloat512VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float512VectorTests::max);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void minFloat512VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float512VectorTests::min);
    }
    ...
    static void gatherMaskedFloat512VectorTests(IntFunction<float[]> fa, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, mask, Float512VectorTests::gatherMasked);
    }
    ...
    static void scatterMaskedFloat512VectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, mask, Float512VectorTests::scatterMasked);
    }
