...
public class Byte256VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<byte[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void ANDC2Byte256VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Byte256VectorTests::ANDC2);
    }



    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void ANDC2Byte256VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Byte256VectorTests::ANDC2);
    }
