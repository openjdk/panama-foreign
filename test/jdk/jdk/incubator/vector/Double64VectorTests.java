...
public class Double64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<double[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void maxDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Double64VectorTests::max);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void minDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Double64VectorTests::min);
    }
    ...
    static void addLanesDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double64VectorTests::addLanesMasked, Double64VectorTests::addLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void mulLanesDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double64VectorTests::mulLanesMasked, Double64VectorTests::mulLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void minLanesDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double64VectorTests::minLanesMasked, Double64VectorTests::minLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void maxLanesDouble64VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double64VectorTests::maxLanesMasked, Double64VectorTests::maxLanesMasked);
    }
