...
public class Short64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<short[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void shiftLeftShort64VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Short64VectorTests::shiftLeft);
    }



    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void shiftLeftShort64VectorTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::shiftLeft);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void shiftRightShort64VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Short64VectorTests::shiftRight);
    }



    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void shiftRightShort64VectorTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::shiftRight);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void shiftArithmeticRightShort64VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Short64VectorTests::shiftArithmeticRight);
    }



    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void shiftArithmeticRightShort64VectorTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::shiftArithmeticRight);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void maxShort64VectorTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::max);
    }
    ...
    @Test(dataProvider = "shortBinaryOpMaskProvider")
    static void minShort64VectorTestsMasked(IntFunction<short[]> fa, IntFunction<short[]> fb,
                                          IntFunction<boolean[]> fm) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::min);
    }
    ...
    static void gatherMaskedShort64VectorTests(IntFunction<short[]> fa, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
            for (int i = 0; i < a.length; i += SPECIES.length()) {
                ShortVector av = ShortVector.fromArray(SPECIES, a, i, vmask, b, i);
                av.intoArray(r, i);
            }
        }

        assertArraysEquals(a, b, r, mask, Short64VectorTests::gatherMasked);
    }
    ...
    static void scatterMaskedShort64VectorTests(IntFunction<short[]> fa, IntFunction<short[]> fb, BiFunction<Integer,Integer,int[]> fs, IntFunction<boolean[]> fm) {
        ...
        assertArraysEquals(a, b, r, mask, Short64VectorTests::scatterMasked);
    }
