...
public class Short64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<short[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void sliceShort64VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
        ...
        assertArraysEquals(a, r, origin, Short64VectorTests::slice);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void sliceShort64VectorTestsBinary(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, Short64VectorTests::slice);
    }
    ...
    @Test(dataProvider = "shortUnaryOpProvider")
    static void unsliceShort64VectorTests(IntFunction<short[]> fa) {
        short[] a = fa.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(a, r, origin, Short64VectorTests::unslice);
    }
    ...
    @Test(dataProvider = "shortBinaryOpProvider")
    static void unsliceShort64VectorTestsBinary(IntFunction<short[]> fa, IntFunction<short[]> fb) {
        short[] a = fa.apply(SPECIES.length());
        short[] b = fb.apply(SPECIES.length());
        short[] r = new short[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, part, Short64VectorTests::unslice);
    }
