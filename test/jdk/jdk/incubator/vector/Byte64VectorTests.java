...
public class Byte64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<byte[]> fr = (vl) -> {
    ...
    static void ANDByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = -1;
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::AND, Byte64VectorTests::AND);
    }
    ...
    static void ANDByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::ANDMasked, Byte64VectorTests::ANDMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ORByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::OR, Byte64VectorTests::OR);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ORByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::ORMasked, Byte64VectorTests::ORMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void XORByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::XOR, Byte64VectorTests::XOR);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void XORByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::XORMasked, Byte64VectorTests::XORMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void ADDByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 0;
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::ADD, Byte64VectorTests::ADD);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void ADDByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::ADDMasked, Byte64VectorTests::ADDMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MULByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        byte ra = 1;
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::MUL, Byte64VectorTests::MUL);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MULByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::MULMasked, Byte64VectorTests::MULMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MINByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::MIN, Byte64VectorTests::MIN);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MINByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::MINMasked, Byte64VectorTests::MINMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void MAXByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Byte64VectorTests::MAX, Byte64VectorTests::MAX);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void MAXByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::MAXMasked, Byte64VectorTests::MAXMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void singleByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        ...
        assertArraysEquals(a, r, Byte64VectorTests::single);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void sliceByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        ...
        assertArraysEquals(a, r, origin, Byte64VectorTests::slice);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void sliceByte64VectorTestsBinary(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, Byte64VectorTests::slice);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void unsliceByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(a, r, origin, Byte64VectorTests::unslice);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void unsliceByte64VectorTestsBinary(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = new byte[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, part, Byte64VectorTests::unslice);
    }
    ...
    static void BITWISE_BLENDByte64VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
