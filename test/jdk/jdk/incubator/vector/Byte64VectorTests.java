...
public class Byte64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<byte[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void lanewise_ANDC2Byte64VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Byte64VectorTests::lanewise_ANDC2);
    }



    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void lanewise_ANDC2Byte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Byte64VectorTests::lanewise_ANDC2);
    }
    ...
    @Test(dataProvider = "byteBinaryOpProvider")
    static void lanewise_FIRST_NONZEROByte64VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Byte64VectorTests::lanewise_FIRST_NONZERO);
    }

    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void lanewise_FIRST_NONZEROByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Byte64VectorTests::lanewise_FIRST_NONZERO);
    }
    ...
    static void andLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::andLanesMasked, Byte64VectorTests::andLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void orLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::orLanesMasked, Byte64VectorTests::orLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void xorLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::xorLanesMasked, Byte64VectorTests::xorLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void addLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::addLanesMasked, Byte64VectorTests::addLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void mulLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::mulLanesMasked, Byte64VectorTests::mulLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void minLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::minLanesMasked, Byte64VectorTests::minLanesMasked);
    }
    ...
    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void maxLanesByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Byte> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Byte64VectorTests::maxLanesMasked, Byte64VectorTests::maxLanesMasked);
    }
    ...
    static void lanewise_BITWISE_BLENDByte64VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb, IntFunction<byte[]> fc) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, c, r, Byte64VectorTests::lanewise_BITWISE_BLEND);
    }


    @Test(dataProvider = "byteTernaryOpMaskProvider")
    static void lanewise_BITWISE_BLENDByte64VectorTests(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
        ...
        assertArraysEquals(a, b, c, r, mask, Byte64VectorTests::lanewise_BITWISE_BLEND);
    }
    ...
    @Test(dataProvider = "byteUnaryOpProvider")
    static void lanewise_ZOMOByte64VectorTests(IntFunction<byte[]> fa) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, r, Byte64VectorTests::lanewise_ZOMO);
    }



    @Test(dataProvider = "byteUnaryOpMaskProvider")
    static void lanewise_ZOMOMaskedByte64VectorTests(IntFunction<byte[]> fa,
                                                IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        ...
        assertArraysEquals(a, r, mask, Byte64VectorTests::lanewise_ZOMO);
    }
