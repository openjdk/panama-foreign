...
public class Byte64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<byte[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void shiftLeftByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void shiftRightByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void shiftArithmeticRightByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void maxByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Byte64VectorTests::max);
    }
    ...
    @Test(dataProvider = "byteBinaryOpMaskProvider")
    static void minByte64VectorTestsMasked(IntFunction<byte[]> fa, IntFunction<byte[]> fb,
                                          IntFunction<boolean[]> fm) {
        byte[] a = fa.apply(SPECIES.length());
        byte[] b = fb.apply(SPECIES.length());
        byte[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Byte64VectorTests::min);
    }
