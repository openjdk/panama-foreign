...
public class Long256VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<long[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void sliceLong256VectorTests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        ...
        assertArraysEquals(a, r, origin, Long256VectorTests::slice);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void sliceLong256VectorTestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, Long256VectorTests::slice);
    }
    ...
    @Test(dataProvider = "longUnaryOpProvider")
    static void unsliceLong256VectorTests(IntFunction<long[]> fa) {
        long[] a = fa.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        for (int ic = 0; ic < INVOC_COUNT; ic++) {
        ...
        assertArraysEquals(a, r, origin, Long256VectorTests::unslice);
    }
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void unsliceLong256VectorTestsBinary(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = new long[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, part, Long256VectorTests::unslice);
    }
    ...
    static void BITWISE_BLENDLong256VectorTests(IntFunction<long[]> fa, IntFunction<long[]> fb,
