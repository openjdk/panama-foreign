...
public class Float64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void maxFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float64VectorTests::max);
    }
    ...
    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void minFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float64VectorTests::min);
    }
