...
public class Float64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<float[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "floatBinaryOpProvider")
    static void lanewise_FIRST_NONZEROFloat64VectorTests(IntFunction<float[]> fa, IntFunction<float[]> fb) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Float64VectorTests::lanewise_FIRST_NONZERO);
    }

    @Test(dataProvider = "floatBinaryOpMaskProvider")
    static void lanewise_FIRST_NONZEROFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<float[]> fb,
                                          IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] b = fb.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Float64VectorTests::lanewise_FIRST_NONZERO);
    }
    ...
    static void addLanesFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float64VectorTests::addLanesMasked, Float64VectorTests::addLanesMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void mulLanesFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float64VectorTests::mulLanesMasked, Float64VectorTests::mulLanesMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void minLanesFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float64VectorTests::minLanesMasked, Float64VectorTests::minLanesMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpMaskProvider")
    static void maxLanesFloat64VectorTestsMasked(IntFunction<float[]> fa, IntFunction<boolean[]> fm) {
        float[] a = fa.apply(SPECIES.length());
        float[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Float> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Float64VectorTests::maxLanesMasked, Float64VectorTests::maxLanesMasked);
    }
    ...
    @Test(dataProvider = "floatUnaryOpProvider")
    static void singleFloat64VectorTests(IntFunction<float[]> fa) {
        float[] a = fa.apply(SPECIES.length());
        ...
        assertArraysEquals(a, r, Float64VectorTests::single);
    }
