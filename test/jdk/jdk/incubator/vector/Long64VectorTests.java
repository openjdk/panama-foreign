...
public class Long64VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<long[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "longBinaryOpProvider")
    static void ANDC2Long64VectorTests(IntFunction<long[]> fa, IntFunction<long[]> fb) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Long64VectorTests::ANDC2);
    }



    @Test(dataProvider = "longBinaryOpMaskProvider")
    static void ANDC2Long64VectorTestsMasked(IntFunction<long[]> fa, IntFunction<long[]> fb,
                                          IntFunction<boolean[]> fm) {
        long[] a = fa.apply(SPECIES.length());
        long[] b = fb.apply(SPECIES.length());
        long[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Long64VectorTests::ANDC2);
    }
