...
public class Double512VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<double[]> fr = (vl) -> {
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void lanewise_FIRST_NONZERODouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, Double512VectorTests::lanewise_FIRST_NONZERO);
    }

    @Test(dataProvider = "doubleBinaryOpMaskProvider")
    static void lanewise_FIRST_NONZERODouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<double[]> fb,
                                          IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, mask, Double512VectorTests::lanewise_FIRST_NONZERO);
    }
    ...
    static void addLanesDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::addLanesMasked, Double512VectorTests::addLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void mulLanesDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::mulLanesMasked, Double512VectorTests::mulLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void minLanesDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::minLanesMasked, Double512VectorTests::minLanesMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void maxLanesDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromValues(SPECIES, mask);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::maxLanesMasked, Double512VectorTests::maxLanesMasked);
    }
    ...
    static void lanewise_FMADouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb, IntFunction<double[]> fc) {
        ...
        assertArraysEquals(a, b, c, r, Double512VectorTests::lanewise_FMA);
    }


    @Test(dataProvider = "doubleTernaryOpMaskProvider")
    static void lanewise_FMADouble512VectorTests(IntFunction<double[]> fa, IntFunction<double[]> fb,
        ...
        assertArraysEquals(a, b, c, r, mask, Double512VectorTests::lanewise_FMA);
    }
