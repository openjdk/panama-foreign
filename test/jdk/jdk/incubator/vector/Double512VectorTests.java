...
public class Double512VectorTests extends AbstractVectorTest {
   ...
   static final IntFunction<double[]> fr = (vl) -> {
    ...
    static void ADDDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 0;
        ...
        assertReductionArraysEquals(a, r, ra, Double512VectorTests::ADD, Double512VectorTests::ADD);
    }
    ...
    static void ADDDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::ADDMasked, Double512VectorTests::ADDMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MULDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        double ra = 1;
        ...
        assertReductionArraysEquals(a, r, ra, Double512VectorTests::MUL, Double512VectorTests::MUL);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MULDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::MULMasked, Double512VectorTests::MULMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MINDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Double512VectorTests::MIN, Double512VectorTests::MIN);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MINDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::MINMasked, Double512VectorTests::MINMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void MAXDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        ...
        assertReductionArraysEquals(a, r, ra, Double512VectorTests::MAX, Double512VectorTests::MAX);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpMaskProvider")
    static void MAXDouble512VectorTestsMasked(IntFunction<double[]> fa, IntFunction<boolean[]> fm) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = fr.apply(SPECIES.length());
        boolean[] mask = fm.apply(SPECIES.length());
        VectorMask<Double> vmask = VectorMask.fromArray(SPECIES, mask, 0);
        ...
        assertReductionArraysEqualsMasked(a, r, ra, mask, Double512VectorTests::MAXMasked, Double512VectorTests::MAXMasked);
    }
    ...
    @Test(dataProvider = "doubleUnaryOpProvider")
    static void singleDouble512VectorTests(IntFunction<double[]> fa) {
        double[] a = fa.apply(SPECIES.length());
        double[] r = new double[a.length];
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void sliceDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        ...
        assertArraysEquals(a, b, r, origin, Double512VectorTests::slice);
    }
    ...
    @Test(dataProvider = "doubleBinaryOpProvider")
    static void unsliceDouble512VectorTestsBinary(IntFunction<double[]> fa, IntFunction<double[]> fb) {
        double[] a = fa.apply(SPECIES.length());
        double[] b = fb.apply(SPECIES.length());
        double[] r = new double[a.length];
        int origin = (new java.util.Random()).nextInt(SPECIES.length());
        ...
        assertArraysEquals(a, b, r, origin, part, Double512VectorTests::unslice);
    }
