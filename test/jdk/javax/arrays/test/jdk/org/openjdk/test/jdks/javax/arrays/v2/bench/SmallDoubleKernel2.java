...
import static javax.arrays.v2.ops.AnyOp.DTIMES_kernel1;
import static javax.arrays.v2.ops.AnyOp.DTIMES_kernel2;
...
public class SmallDoubleKernel2 extends Baseline {
    ...
    public static void timingSmall() {
        ...
        set(c, filler);
        long t;
        System.out.println("Matrix mult. times double-textbook vs Double-generic-fully-specialized-kernel, milliseconds");
        Double Sum = 0.0;
        double sum = 0.0;
        for (int i = 0; i < 25; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                t = System.currentTimeMillis();
                A.set(DTIMES_kernel2.apply(B,C));
