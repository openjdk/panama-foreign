...
public class SmallDoubleTransposed extends Baseline {
    ...
    public static void timingSmall() {
        ...
        RowMatrix.D B = new RowMatrix.D(N,P);
        RowMatrix.D C = new RowMatrix.D(P,N);
        ...
        set(c, filler);
        long t;
        System.out.println("Matrix multiplication times double-textbook vs Double-generic-row-major, milliseconds");
        Double Sum = 0.0;
        double sum = 0.0;
        for (int i = 0; i < 25; i++) {
            for (int j = 0; j < 4; j++) {
