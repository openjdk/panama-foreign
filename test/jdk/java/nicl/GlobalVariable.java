...
public class GlobalVariable {
    ...
    static interface globvar {
        ...
        @C(file="dummy", line=1, column=1, USR="c:@global_v256")
        @NativeType(layout="=256v", ctype="dummy", size=32, name="global_v256")
        public abstract Long4 global_v256$get();
        public abstract void global_v256$set(Long4 arg);
        public abstract Reference<Long4> global_v256$ref();
    ...
    public void testv256() {
        // __m256i
        assertEquals(Long4.make(42, 0, 0, 0), i.global_v256$get());
        assertEquals(Long4.make(42, 0, 0, 0), i.global_v256$ref().get());

        i.global_v256$set(Long4.make(47, 0, 0, 0));

        assertEquals(Long4.make(47, 0, 0, 0), i.global_v256$get());
        assertEquals(Long4.make(47, 0, 0, 0), i.global_v256$ref().get());
    }
    ...
    static void assertEquals(Long4 expected, Long4 actual) {
