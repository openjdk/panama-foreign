...
public class CallingSequenceBuilderTest {
     ...
     * m(m0);
     */
    public void testOneM256() {
        CallingSequenceBuilder builder = new CallingSequenceBuilder(CallingSequenceBuilderImpl.class);

        CallingSequence recipe = builder
                .addArgument(Types.M256, "m0")
                .build();
        ...
        assertEquals(builder.getArguments().get(0), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(0).getMember());
     ...
     * __m256 m0, m1;
     *
     * m(__m256 m0, __m256 m1);
     *
     * m(m0, m1);
     */
    public void testTwoM256() {
        CallingSequenceBuilder builder = new CallingSequenceBuilder(CallingSequenceBuilderImpl.class);

        CallingSequence recipe = builder
                .addArgument(Types.M256, "m0")
                .addArgument(Types.M256, "m1")
                .build();
        ...
        assertEquals(builder.getArguments().get(0), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(0).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(0).getOffset());
        assertEquals(builder.getArguments().get(1), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(1).getMember());
     ...
     * __m256 m0, m1, [...] m9;
     *
     * m(__m256 m0, __m256 m1, [...], __m256 m9);
     *
     * m(m0, m1, [...], m9);
     */
    public void testMultiM256() {
        CallingSequenceBuilder builder = new CallingSequenceBuilder(CallingSequenceBuilderImpl.class);

        // Fill all SSE registers and spill 2 args on stack
        for (int i = 0; i < Constants.MAX_VECTOR_ARGUMENT_REGISTERS + 2; i++) {
            builder.addArgument(Types.M256, "m" + i);
        }
        ...
        assertEquals(0, recipe.getBindings(StorageClass.INTEGER_ARGUMENT_REGISTER).size());
        assertEquals(Constants.MAX_VECTOR_ARGUMENT_REGISTERS, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).size());
        assertEquals(8, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).size());
        ...
        for (int i = 0, arg = Constants.MAX_VECTOR_ARGUMENT_REGISTERS; i < 2; i++, arg++) {
            for (int j = 0; j < 4; j++) {
                int index = i * 4 + j;
                assertEquals(builder.getArguments().get(arg), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(index).getMember());
                assertEquals(j * 8, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(index).getOffset());
            }
        }
    }
    ...
    public void testAbiExample() {
        ...
        assertEquals(4, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).size());
        assertEquals(4, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).size());
        ...
        // n
        assertEquals(builder.getArguments().get(8), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(3).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(3).getOffset());

        // i
        assertEquals(builder.getArguments().get(9), recipe.getBindings(StorageClass.INTEGER_ARGUMENT_REGISTER).get(5).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.INTEGER_ARGUMENT_REGISTER).get(5).getOffset());

        // j
        assertEquals(builder.getArguments().get(10), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(2).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(2).getOffset());

        // k
        assertEquals(builder.getArguments().get(11), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(3).getMember());
    ...
    public void testAbiExampleVarargs() {
        ...
        // u
        assertEquals(builder.getArguments().get(2), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(1).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(1).getOffset());

        // b
        assertEquals(builder.getArguments().get(3), recipe.getBindings(StorageClass.INTEGER_ARGUMENT_REGISTER).get(1).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.INTEGER_ARGUMENT_REGISTER).get(1).getOffset());

        // ld
        assertEquals(builder.getArguments().get(4), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(0).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(0).getOffset());
        assertEquals(builder.getArguments().get(4), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(1).getMember());
        assertEquals(8, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(1).getOffset());

        // y
        assertEquals(builder.getArguments().get(5), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(4).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(4).getOffset());
        assertEquals(builder.getArguments().get(5), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(5).getMember());
        assertEquals(8, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(5).getOffset());
        assertEquals(builder.getArguments().get(5), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(6).getMember());
        assertEquals(16, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(6).getOffset());
        assertEquals(builder.getArguments().get(5), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(7).getMember());
        assertEquals(24, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(7).getOffset());

        // n
        assertEquals(builder.getArguments().get(6), recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(2).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.VECTOR_ARGUMENT_REGISTER).get(2).getOffset());
    }
     ...
     * m(m0);
     */
    public void testUnnamedM256() {
        CallingSequenceBuilder builder = new CallingSequenceBuilder(CallingSequenceBuilderImpl.class);

        CallingSequence recipe = builder
                .addArgument(Types.M256)
                .build();
     ...
     * m(m0, m1);
     */
    public void testNamedAndUnnamedM256() {
        CallingSequenceBuilder builder = new CallingSequenceBuilder(CallingSequenceBuilderImpl.class);
        ...
        assertEquals(builder.getArguments().get(1), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(0).getMember());
        assertEquals(0, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(0).getOffset());
        assertEquals(builder.getArguments().get(1), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(1).getMember());
        assertEquals(8, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(1).getOffset());
        assertEquals(builder.getArguments().get(1), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(2).getMember());
        assertEquals(16, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(2).getOffset());
        assertEquals(builder.getArguments().get(1), recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(3).getMember());
        assertEquals(24, recipe.getBindings(StorageClass.STACK_ARGUMENT_SLOT).get(3).getOffset());
    }
