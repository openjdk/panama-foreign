 ...
 * @run main/othervm TestHandshakeBuffer
 * @run main/othervm -Xint TestHandshakeBuffer
 * @run main/othervm -XX:TieredStopAtLevel=1 TestHandshakeBuffer
 */
...
public class TestHandshakeBuffer {
