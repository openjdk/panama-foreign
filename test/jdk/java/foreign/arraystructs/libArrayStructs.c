...
EXPORT struct S1 F1(struct S1 (*cb)(struct S1), struct S1 a0) { return cb(a0); }
EXPORT struct S2 F2(struct S2 (*cb)(struct S2), struct S2 a0) { return cb(a0); }
EXPORT struct S3 F3(struct S3 (*cb)(struct S3), struct S3 a0) { return cb(a0); }
EXPORT struct S4 F4(struct S4 (*cb)(struct S4), struct S4 a0) { return cb(a0); }
EXPORT struct S5 F5(struct S5 (*cb)(struct S5), struct S5 a0) { return cb(a0); }
EXPORT struct S6 F6(struct S6 (*cb)(struct S6), struct S6 a0) { return cb(a0); }
EXPORT struct S7 F7(struct S7 (*cb)(struct S7), struct S7 a0) { return cb(a0); }
EXPORT struct S8 F8(struct S8 (*cb)(struct S8), struct S8 a0) { return cb(a0); }
EXPORT struct S9 F9(struct S9 (*cb)(struct S9), struct S9 a0) { return cb(a0); }
EXPORT struct S10 F10(struct S10 (*cb)(struct S10), struct S10 a0) { return cb(a0); }
EXPORT struct S11 F11(struct S11 (*cb)(struct S11), struct S11 a0) { return cb(a0); }
EXPORT struct S12 F12(struct S12 (*cb)(struct S12), struct S12 a0) { return cb(a0); }
EXPORT struct S13 F13(struct S13 (*cb)(struct S13), struct S13 a0) { return cb(a0); }
EXPORT struct S14 F14(struct S14 (*cb)(struct S14), struct S14 a0) { return cb(a0); }
EXPORT struct S15 F15(struct S15 (*cb)(struct S15), struct S15 a0) { return cb(a0); }
EXPORT struct S16 F16(struct S16 (*cb)(struct S16), struct S16 a0) { return cb(a0); }
